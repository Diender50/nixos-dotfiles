self: super: {
  wf-config = super.wf-config.overrideAttrs (oldAttrs: {
    ...
    src = super.fetchFromGitHub {
      owner = "WayfireWM";
      repo = "wf-config";
      rev = "refs/tags/v0.10.0"; # vérifier le tag exact sur GitHub
      sha256 = "WcGt6yl2LpLnAOVtiCyMyWsoMAUMG1MYhvW/m2DDMX4="; # remplacer par le sha correct
    };
    buildInputs = (oldAttrs.buildInputs or []) ++ [ super.libxml2 ];
  });

  wayfirePlugins.wayfire-plugins-extra = super.wayfirePlugins.wayfire-plugins-extra.overrideAttrs (oldAttrs: {
    version = "0.10.0";
    src = super.fetchFromGitHub {
      owner = "WayfireWM";
      repo = "wayfire-plugins-extra";
      rev = "refs/tags/v0.10.0"; # vérifier le tag exact sur GitHub
      sha256 = "0cAPaj5PmGgX/Q0mkdsyjZTQ5JBPrnvB2EnLj89v13g="; # remplacer par le sha correct
    };
  ...
  wayfirePlugins.wcm = super.wayfirePlugins.wcm.overrideAttrs (oldAttrs: {
    version = "0.10.0";
    src = super.fetchFromGitHub {
      owner = "WayfireWM";
      repo = "wcm";
      rev = "refs/tags/v0.10.0"; # vérifier le tag exact sur GitHub
      sha256 = "O4BYwb+GOMZIn3I2B/WMJ5tUZlaegvwBuyNK9l/gxvQ="; # remplacer par le sha correct
    };
    mesonFlags = let
      flags = oldAttrs.mesonFlags or [];
    in
  ...
  wayfirePlugins.wf-shell = super.wayfirePlugins.wf-shell.overrideAttrs (oldAttrs: {
    version = "0.10.0";
    src = super.fetchFromGitHub {
      owner = "WayfireWM";
      repo = "wf-shell";
      ...
      sha256 = "PLTeFGecxVwU2LdwnDwiWB1OcbaZjJemMpT0pcCFf/w="; # Le sha tel que dans la source initiale
    };
